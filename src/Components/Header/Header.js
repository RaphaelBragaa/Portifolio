...
//import { ScrollProvider, ScrollContext } from "../../Context/DropButtonContext";
...
export default function Header({executeScroll}){
    ...
    const images = [linkr, trackit, eats2, cineflex, MyWallet,Drivent]
  const description = [
  ...
  function handleItemClick () {
    ...
    return(
        <>
            ...
            <div>
                <h2 onClick={handleItemClick}>Sobre</h2>
                <h2 >Tecnologias</h2>
                <h2 >Projetos</h2>
                <h2 >Contatos</h2>
            </div>
            ...
            <About />
            <Tecnologies />
            <Projects images={images} descriptions={description} projects={projects} />
            <Contact />
        </>
    )
}
